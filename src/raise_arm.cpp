...
int main(int argc, char * argv[])
{
  ...
  //raising position for real arm on spot
  target_pose.position.x = 0.232;
  target_pose.position.y = -0.006;
  target_pose.position.z = 0.947;

  target_pose.orientation.x = 0.531;
  target_pose.orientation.y = 0.535;
  target_pose.orientation.z = 0.441;
  target_pose.orientation.w = 0.487;
